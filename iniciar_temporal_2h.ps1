...
# Tunnel, sin necesidad de cuenta) por 2 horas, y despues cierra todo solo.
# No es parte de la app -- es un script de un solo uso para compartir acceso
# temporal desde fuera de la wifi. Border rapido, no pensado para dejar
# corriendo mas alla de esas 2 horas.
...
# 3) Cierra el tunel solo despues de 2 horas (el servidor local se deja
